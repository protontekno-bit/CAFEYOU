...
export const POPULAR_KARAOKE_SONGS: PopularPresetSong[] = [
  ...
  { title: 'Komang', artist: 'Raim Laode', videoId: 'GTkEBm2zFQQ', category: 'Pop Indo' },
  { title: 'Hampa', artist: 'Ari Lasso', videoId: 'G0C82-l4aVg', category: 'Pop Indo' },
  { title: 'Tak Ingin Usai', artist: 'Keisya Levronka', videoId: 'BCvBpPmPRBE', category: 'Pop Indo' },
  { title: 'Akad', artist: 'Payung Teduh', videoId: 'Y_N3b_9bAb0', category: 'Pop Indo' },
  { title: 'Kemesraan', artist: 'Iwan Fals', videoId: 'JGwWNGJdvx8', category: 'Pop Indo' },
  { title: 'Bento', artist: 'Iwan Fals', videoId: 'jU3Mj9KCWYQ', category: 'Pop Indo' },
  { title: 'Hati-Hati di Jalan', artist: 'Tulus', videoId: 'w3LWkGjXJg4', category: 'Pop Indo' },
  { title: 'Cinta Luar Biasa', artist: 'Andmesh', videoId: 'G0C82-l4aVg', category: 'Pop Indo' },
  { title: 'Menghapus Jejakmu', artist: 'Peterpan', videoId: 'oBKDGHRExw0', category: 'Pop Indo' },
  { title: 'Runtuh', artist: 'Feby Putri ft. Fiersa Besari', videoId: 'cUST5WFBKQo', category: 'Pop Indo' },
  { title: 'Monokrom', artist: 'Tulus', videoId: 'qHaWFSkxHKA', category: 'Pop Indo' },
  ...
  { title: 'Kopi Dangdut', artist: 'Fahmi Shahab', videoId: 'K3LySBt_Pxk', category: 'Dangdut & Koplo' },
  { title: 'Los Dol', artist: 'Denny Caknan', videoId: 'RQ4tgaYlPkc', category: 'Dangdut & Koplo' },
  { title: 'Kartonyono Medot Janji', artist: 'Denny Caknan', videoId: 'WStbFp6Cjcc', category: 'Dangdut & Koplo' },
  { title: 'Secangkir Kopi', artist: 'Jhonny Iskandar', videoId: 'pds8ZU7Cqxw', category: 'Dangdut & Koplo' },
  { title: 'Darah Muda', artist: 'Rhoma Irama', videoId: 'o8ioUzSzGmA', category: 'Dangdut & Koplo' },
  { title: 'Mendung Tanpo Udan', artist: 'Ndarboy Genk', videoId: 'k4V3Mo61fJM', category: 'Dangdut & Koplo' },
  { title: 'Ojo Dibandingke', artist: 'Farel Prayoga', videoId: 'sQ4LJQW6h0M', category: 'Dangdut & Koplo' },
  { title: 'Joko Tingkir Ngombe Dawet', artist: 'Yeni Inka', videoId: 'lNLVPYlQ8GM', category: 'Dangdut & Koplo' },

  // Rock & 90s/2000s
  { title: 'Kisah Kasih di Sekolah', artist: 'Chrisye', videoId: 'kBq2jEFJUH8', category: 'Rock & 90s' },
  { title: 'Pelangi di Matamu', artist: 'Jamrud', videoId: 'k4V3Mo61fJM', category: 'Rock & 90s' },
  { title: 'Terlalu Manis', artist: 'Slank', videoId: 'f0l6jU_29eQ', category: 'Rock & 90s' },
  { title: 'Ku Tak Bisa', artist: 'Slank', videoId: 'TpNi-Cn7k4s', category: 'Rock & 90s' },
  { title: 'Kasih Tak Sampai', artist: 'Padi', videoId: '2Vv-BfVoq4g', category: 'Rock & 90s' },
  { title: 'Beraksi', artist: 'Kotak', videoId: 'c6AzTrSe_0s', category: 'Rock & 90s' },
  { title: 'Sephia', artist: 'Sheila On 7', videoId: 'HxFEJFmLdqg', category: 'Rock & 90s' },
  ...
  { title: 'Zona Nyaman', artist: 'Fourtwnty', videoId: 'BGdB_4b0-EU', category: 'Akustik & Santai' },
  { title: 'Rehat', artist: 'Kunto Aji', videoId: 'Ey_BKLM6JlA', category: 'Akustik & Santai' },
  { title: 'Celengan Rindu', artist: 'Fiersa Besari', videoId: 'R5WxJhpq5bo', category: 'Akustik & Santai' },
